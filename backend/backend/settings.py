...
SECRET_KEY = 'django-insecure-@isl+y9dfajk%z9vg_j1qov=xctos(4=7n%q^k=d(*3-5iggw!'
...
MIDDLEWARE = [
    ...
    'users.middleware.RequestResponseLoggingMiddleware',
    'users.middleware.ErrorLoggingMiddleware',
]
